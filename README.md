# [模块构建工具](https://ssu.oom-wg.dev/dev/module)

[NGA SDK](https://github.com/ShIroRRen/NGA-SDK) (构建时自动集成 Shell Utils，自动混淆加密`action.sh`、`customize.sh`和`nga-utils.sh`)

[模块示例](https://github.com/OOM-WG/ShiroSU-Module-EG) (使用本工具需要从此模板生成模块)
